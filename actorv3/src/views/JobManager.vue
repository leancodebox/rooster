...
function getInitData(type: number) {
  return {
    ...
    options: { maxFailures: 5, outputPath: '/tmp', outputType: 1 }, edit: false
  }
}
  ...
  <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div>
        ...
        <div class="overflow-x-auto">
          <table class="table table-zebra table-xs border border-base-300 rounded-lg">
              <thead>
    ...
    <div v-if="showLogModal" class="modal modal-open">
      <div class="modal-box w-11/12 max-w-2xl">
        ...
        <pre class="max-h-[420px] overflow-auto bg-black text-gray-100 p-3 rounded font-mono text-xs">{{ logContent }}</pre>
